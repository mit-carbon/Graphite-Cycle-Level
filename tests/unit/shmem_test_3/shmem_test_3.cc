...
int main(int argc, char* argv[])
{
   ...
   Event::reRegisterHandler(Event::START_THREAD, startSimulation);
   Event::registerHandler(EVENT_ISSUE_MEMORY_ACCESS, processIssueMemoryAccessEvent);
   Event::reRegisterHandler(Event::COMPLETE_MEMORY_ACCESS, processCompleteMemoryAccessEvent);
   ...
   Event::unregisterHandler(Event::START_THREAD);
