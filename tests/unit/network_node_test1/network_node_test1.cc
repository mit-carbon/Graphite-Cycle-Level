...
int main(int argc, char *argv[])
{
   ...
   vector<SInt32> num_output_endpoints_list(num_output_channels, 1);
   ...
   vector<SInt32> input_buffer_size_list(num_input_channels, 1);
   vector<SInt32> downstream_buffer_size_list(num_output_channels, 2);
   ...
   NetworkNode* network_node = new NetworkNode(Router::Id(5,0), flit_width,
...
list<NetPacket*> createNetPacketList()
{
   ...
   addFlit(net_packet_list, Flit::HEAD, 5, 1, Router::Id(1,0), Router::Id(5,0), 3, &output_endpoints);

   // Head Flit - 1
   output_endpoints << 0 << 0;
   addFlit(net_packet_list, Flit::HEAD, 6, 1, Router::Id(2,0), Router::Id(5,0), 1, &output_endpoints);

   // Tail Flit - 1
   addFlit(net_packet_list, Flit::TAIL, 7, 1, Router::Id(2,0), Router::Id(5,0));
   
   // Body Flit - 0
   addFlit(net_packet_list, Flit::BODY, 7, 1, Router::Id(1,0), Router::Id(5,0));

   // Tail Flit - 0
   addFlit(net_packet_list, Flit::TAIL, 10, 1, Router::Id(1,0), Router::Id(5,0));
