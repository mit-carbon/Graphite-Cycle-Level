...
public:
   ...
   void processReceivedPacket(const NetPacket* net_packet);
   // Output Summary 
...
private:
   ...
   // ENet
   UInt64 _total_packets_received_on_enet;
   UInt64 _total_flits_received_on_enet;
   UInt64 _total_bytes_received_on_enet;
   UInt64 _total_packet_latency_on_enet;
   UInt64 _last_packet_recv_time_on_enet;
   // ONet - (actually ENet->ONet->StarNet)
   UInt64 _total_packets_received_on_onet;
   UInt64 _total_flits_received_on_onet;
   UInt64 _total_bytes_received_on_onet;
   UInt64 _total_packet_latency_on_onet;
   UInt64 _last_packet_recv_time_on_onet;
   ...
   void outputPerformanceCountersSummary(ostream& out);
